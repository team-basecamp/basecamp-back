...
public class ReviewController {
    ...
    @PostMapping(value = "/api/v1/reservations/{reservationId}/reviews", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    ...
    @Operation(
            summary = "리뷰 수정",
            description = "예약자 본인이 작성한 리뷰의 평점·내용과 첨부 이미지를 수정한다. "
    ...
    @Operation(summary = "리뷰 삭제", description = "예약자 본인이 작성한 리뷰를 삭제한다. "
            + "첨부 이미지도 images 행과 실제 파일까지 되돌릴 수 없게 함께 삭제된다.")
