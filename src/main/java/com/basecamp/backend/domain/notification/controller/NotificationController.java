...
public class NotificationController {
	...
	@Operation(summary = "알림 구독(SSE)",
			description = "로그인한 사용자의 실시간 알림 스트림을 연다. 새 알림이 발생하면 `notification` 이벤트로 push 된다. "
	...
	public ResponseEntity<UnreadCountResponse> getUnreadCount(@AuthenticationPrincipal AuthUser user) {
