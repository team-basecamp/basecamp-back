...
public record PaymentResponse(
        ...
        @Schema(description = "포트원 결제 건 ID")
        String paymentId,

        Long amount,

        @Schema(description = "결제 수단. 결제 완료 전에는 비어 있다.")
        PaymentMethod paymentMethod,

        @Schema(description = "READY / PAID / REFUNDED / FAILED")
        PaymentStatus status,

        @Schema(description = "결제 실패 사유. 실패한 경우에만 채워진다.")
