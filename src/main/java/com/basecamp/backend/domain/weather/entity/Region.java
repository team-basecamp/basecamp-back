 ...
 *
 * <p>행정구역은 바뀌지 않고 개수도 17개로 고정이므로 DB나 설정이 아닌 코드 상수로 둔다.
 * (좌표는 각 시·도청 소재지 기준의 대표값이다. 시/도 단위 날씨라 수 km 오차는 무의미하다.)</p>
 */
@Getter
public enum Region {
    ...
    JEONNAM_GWANGJU("전남광주통합특별시", "126.8526", "35.1595"),    DAEJEON("대전광역시", "127.3845", "36.3504"),
