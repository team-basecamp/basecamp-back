 ...
 *
 * <p>{@code grant_type=authorization_code} 표준 토큰 요청은 provider 무관하게 동일하므로,
 * 엔드포인트/자격증명이 담긴 {@link ClientRegistration} 만 주입받아 카카오/구글/네이버가 공통으로 재사용한다.
 * ({@code client_id}/{@code client_secret} 은 body 로 전송 — {@code client_secret_post})</p>
 */
@Component
