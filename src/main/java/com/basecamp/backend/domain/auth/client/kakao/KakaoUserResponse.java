 ...
 *
 * <p>이메일/닉네임/프로필이미지는 사용자의 동의 항목에 따라 누락될 수 있어 모두 nullable 로 다룬다.
 * 특히 email 은 미동의 시 {@code null} 이며, 이 경우 상위 로그인 로직이
 * {@link com.basecamp.backend.common.exception.ErrorCode#EMAIL_CONSENT_REQUIRED} 로 거부한다.</p>
 */
