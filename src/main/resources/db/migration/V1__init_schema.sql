...
CREATE TABLE reviews (
    ...
    camp_id        BIGINT         NOT NULL               COMMENT '리뷰 대상 캠핑장',
    user_id        BIGINT         NOT NULL               COMMENT '리뷰 작성 회원',
    ...
    INDEX      idx_reviews_camp (camp_id, created_at DESC),
    INDEX      idx_reviews_user (user_id),

    CONSTRAINT fk_reviews_camp
        FOREIGN KEY (camp_id) REFERENCES camps (camp_id)
        ON DELETE CASCADE,
